...
/// @brief Converts a flattaned matrix (in vector form) back to the physical 2D matrix.
/// @param psi_flat Matrix 1*n containing flattened representation of wave function. 
